...
QuickViewer(u, globdat, comp=0, dpi=600, fname='img/core-plots/state0-x.png')
QuickViewer(u, globdat, comp=1, dpi=600, fname='img/core-plots/state0-y.png')
QuickViewer(strain_xx, globdat, dpi=600, fname='img/core-plots/strain-xx.png')
QuickViewer(strain_yy, globdat, dpi=600, fname='img/core-plots/strain-yy.png')

QuickViewer(err, globdat, comp=0, dpi=600, fname='img/core-plots/error_state0-x.png')
QuickViewer(err, globdat, comp=1, dpi=600, fname='img/core-plots/error_state0-y.png')
QuickViewer(err_grad, globdat, comp=0, dpi=600, fname='img/core-plots/error_strain-xx.png')
QuickViewer(err_grad, globdat, comp=1, dpi=600, fname='img/core-plots/error_strain-yy.png')

QuickViewer(u_post, globdat, comp=0, dpi=600, fname='img/mean_state0-x_posterior.png')
QuickViewer(u_post, globdat, comp=1, dpi=600, fname='img/mean_state0-y_posterior.png')

QuickViewer(std_u_prior, globdat, comp=0, dpi=600, fname='img/std_state0-x_prior.png')
QuickViewer(std_u_prior, globdat, comp=1, dpi=600, fname='img/std_state0-y_prior.png')
QuickViewer(std_u_post, globdat, comp=0, dpi=600, fname='img/std_state0-x_posterior.png')
QuickViewer(std_u_post, globdat, comp=1, dpi=600, fname='img/std_state0-y_posterior.png')
QuickViewer(std_eps_xx_prior, globdat, dpi=600, fname='img/std_strain-xx_prior.png')
QuickViewer(std_eps_yy_prior, globdat, dpi=600, fname='img/std_strain-yy_prior.png')
QuickViewer(std_eps_xx_post, globdat, dpi=600, fname='img/std_strain-xx_posterior.png')
QuickViewer(std_eps_yy_post, globdat, dpi=600, fname='img/std_strain-yy_posterior.png')
