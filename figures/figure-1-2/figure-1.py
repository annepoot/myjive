...
for N_coarse in [2,4,8,16,32,64]:
    ...
    create_dat(data=x,
               headers='x',
               fname='output/mesh_Nf-64.dat'.format(N_coarse))
    ...
    create_dat(data=[u_prior,u_post,std_u_prior,std_u_post,u_coarse,u],
               ...
               fname='output/results_Nc-{}_Nf-64.dat'.format(N_coarse))

    create_dat(data=samples_u_prior,
               headers='prior_sample_{}',
               fname='output/samples-prior_Nc-{}_Nf-64.dat'.format(N_coarse))

    create_dat(data=samples_u_post,
               headers='posterior_sample_{}',
               fname='output/samples-posterior_Nc-{}_Nf-64.dat'.format(N_coarse))
