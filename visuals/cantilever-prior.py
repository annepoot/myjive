...
props = pu.parse_file('cantilever-prior.pro')
...
plt.savefig(folder + 'prior-image_cmap-{}.pdf'.format(cmap_name), transparent=True)
for dpi in [300, 600, 1200]:
    plt.savefig(folder + 'prior-image_cmap-{}_dpi-{}.png'.format(cmap_name,dpi), dpi=dpi, transparent=True)
