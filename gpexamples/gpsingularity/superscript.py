...
QuickViewer(u, globdat, comp=1, dpi=600, title=r'displacement ($u_y$)', fname='img/core-plots/state0-y.png')
QuickViewer(strain_xx, globdat, dpi=600, title=r'strain ($\varepsilon_{xx}$)', fname='img/core-plots/strain-xx.png')
QuickViewer(strain_yy, globdat, dpi=600, title=r'strain ($\varepsilon_{yy}$)', fname='img/core-plots/strain-yy.png')

QuickViewer(err, globdat, comp=0, dpi=600, title=r'displacement error ($\Delta_{u_x}$)', fname='img/core-plots/error_state0-x.png')
QuickViewer(err, globdat, comp=1, dpi=600, title=r'displacement error ($\Delta_{u_y}$)', fname='img/core-plots/error_state0-y.png')
...
QuickViewer(err_grad, globdat, comp=1, dpi=600, title=r'strain error ($\Delta_{\varepsilon_{yy}}$)', fname='img/core-plots/error_strain-yy.png')

QuickViewer(u_post, globdat, comp=0, dpi=600, title=r'posterior mean displacement ($m_x^*$)', fname='img/mean_state0-x_posterior.png')
QuickViewer(u_post, globdat, comp=1, dpi=600, title=r'posterior mean displacement ($m_y^*$)', fname='img/mean_state0-y_posterior.png')
...
QuickViewer(std_u_prior, globdat, comp=1, dpi=600, title=r'prior std displacement ($\sigma_{u_{y}}$)', fname='img/std_state0-y_prior.png')
...
QuickViewer(std_u_post, globdat, comp=1, dpi=600, title=r'posterior std displacement ($\sigma^*_{u_{y}}$)', fname='img/std_state0-y_posterior.png')
...
QuickViewer(std_eps_yy_prior, globdat, dpi=600, title=r'prior std strain ($\sigma_{\varepsilon_{yy}}$)', fname='img/std_strain-yy_prior.png')
...
QuickViewer(std_eps_yy_post, globdat, dpi=600, title=r'posterior std strain ($\sigma^*_{\varepsilon_{yy}}$)', fname='img/std_strain-yy_posterior.png')
